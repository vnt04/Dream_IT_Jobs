        ...
        <div className="2xl:px-24 px-4 md:y-4 y-2 h-auto bg-[#f5f5f5]">
            <div className="flex justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="my-5 font-bold text-xl lg:text-2xl text-red-600">hàng đầu</h1>
                </div>
                <div className="flex gap-3 items-center">
                    <a href="" className="underline text-blue-500">Xem tất cả</a>
                    <button className="h-8 w-8 font-bold border border-solid text-[18px] rounded-[50%] text-teal-600 border-teal-600">&lt;</button>
                    <button className="h-8 w-8 font-bold border border-solid text-[18px] rounded-[50%] text-teal-600 border-teal-600">&gt;</button>
                </div>
